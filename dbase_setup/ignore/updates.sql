...
-- INSERT
-- New Status (referencing mediaID in Media for an existing user). Case 1
...
-- Create new mediaID Foreign key
...
-- Create new username Foreign key
INSERT INTO Users(username, gender)
VALUES ('newuser', 'non-binary');

-- Create status with new Foreign keys
INSERT INTO SetStatus(mediaID, username, status, rewatch)
